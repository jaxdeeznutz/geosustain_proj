...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    ...
    role = currentRole == 'analyst' ? 'Agricultural Planning Analyst' : 'Farmer';
  }
  ...
  String get apiRole => role == 'Agricultural Planning Analyst' ? 'analyst' : 'farmer';
                ...
                child: Column(children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'Agricultural Planning Analyst', child: Text('Agricultural Planning Analyst')),
                    ],
...
Color suitabilityBadgeColor(Map<String, dynamic>? data) {
  ...
  if (label.contains('MODERATE') || label.contains('CONDITION')) return const Color(0xFF8BDD75);
